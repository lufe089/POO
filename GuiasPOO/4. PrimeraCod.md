...
public:
    Persona() = default;   // Constructor x defecto
...
### Formas de acceder a atributos en C++
Cuando trabajamos con clases en C++, los atributos son como **cajones de un mueble**: cada objeto tiene sus propios cajones, y los métodos de la clase saben cómo abrirlos. Existen diferentes formas de abrir esos cajones, cada una con una utilidad distinta.
#### 1. Acceso directo
Imagina que estás en tu propia casa y quieres abrir el cajón de tu escritorio. No necesitas decir más: simplemente lo abres.  
Así funciona el **acceso directo** dentro de la clase: basta con usar el nombre del atributo.
...
public:
    void setNombre(std::string nuevoNombre) {
        nombre = nuevoNombre; // Acceso directo al atributo
    }
};
```
...
#### 2. Usando `this->`
A veces hay confusión: ¿hablamos del “cajón” del objeto o de una variable local con el mismo nombre?  
Aquí aparece el puntero implícito `this`, que es como **señalar con el dedo**: “este cajón de este objeto”.
...
Puede encontrar la implementación de este ejemplo en: https://github.com/lufe089/POOEjemploCurso.git
