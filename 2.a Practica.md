# Quiz: Transición de enunciado a diseño orientado a objetos
...
**Enunciado:**  
En la aplicación, se proyectan dos películas: *"Oppenheimer"* e *"Intensamente 2"*.  

**Pregunta:**  
¿Cuál de las siguientes afirmaciones es correcta?  

- a) *"Oppenheimer"* es una clase e *"Intensamente 2"* es otra clase.  
- b) *"Oppenheimer"* e *"Intensamente 2"* son objetos de la clase `Película`.  
...
- c) La clase `Usuario`, para que todos los objetos usen este atributo.  
- d) La clase `Película`.  
